  ...
  export const SITE_LABEL = 'Kenai Borough'
  export const SITE_DOMAIN = 'https://kenaiborough.com'
  ...
  export const SITE_ROLE_OPTIONS = [
    { value: 'visitor', label: 'Browse the borough network' },
{ value: 'business_owner', label: 'Manage a local business listing' },
